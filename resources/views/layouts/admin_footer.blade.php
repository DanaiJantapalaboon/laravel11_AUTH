<footer class="app-footer">
    <div class="app-footer__inner">
        <div class="app-footer-left">
            <div class="text-muted ml-4">หน่วยงาน ่ฟาหสกด่สฟาห่กดาสฟห่กดส่ฟห่กดนรฟรหด</div>
        </div>
        <div class="app-footer-right">
            <ul class="header-megamenu nav">
                <li class="nav-item">
                    <a data-placement="top" rel="popover-focus" data-offset="300" data-toggle="popover-custom" class="nav-link">Mega Menu<i class="lnr-list ml-2 opacity-8"></i></a>
