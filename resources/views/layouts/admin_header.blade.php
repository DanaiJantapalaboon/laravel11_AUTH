                    ...
                    <ul class="header-megamenu nav">
                        ...
                        <li class="nav-item">
                            <a href="javascript:void(0);" data-placement="bottom" rel="popover-focus" data-offset="300" data-toggle="popover-custom" class="nav-link">
                                <i class="lnr-list"></i>&nbsp;&nbsp;Mega Menu
                                <i class="lnr-chevron-down lnr-chevron-down-avatar ml-2 opacity-5"></i>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="pointer-events: none;"><i class="lnr-clock"></i>&nbsp;&nbsp;<span id="date"></span>&nbsp;<span id="clock"></span></a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-plum-plate">
                                        <div class="menu-header-image" style="background-image: url('assets/admin/images/abstract4.jpg');"></div>
                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true"
                                ...
                                <div class="dropdown-menu-header mb-0">
                                    <div class="dropdown-menu-header-inner bg-deep-blue">
                                        <div class="menu-header-image opacity-1" style="background-image: url('assets/admin/images/city2.jpg');"></div>
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-info">
                                                    <div class="menu-header-image opacity-2" style="background-image: url({{ asset('images/city3.jpg') }});"></div>
